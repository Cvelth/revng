/// \file RegisterUsageAnalysis.cpp

//
// This file is distributed under the MIT License. See LICENSE.md for details.
//

#define BOOST_TEST_MODULE RegisterUsageAnalysis
bool init_unit_test();
#include "boost/test/unit_test.hpp"

#include "revng/RegisterUsageAnalysis/Liveness.h"
#include "revng/RegisterUsageAnalysis/ReachingDefinitions.h"
