...
from revng.model import Binary, StructBase, get_element_by_path  # type: ignore[attr-defined]
...
class Project(ABC):
    ...
    def _load(self):
        """
        Load the model and pipeline description, this is used when you want to reload
        from the resumed dir.
        """
        pass
