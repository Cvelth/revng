...
private:
  ...
  void emitDeclarationTypedef(mlir::clift::DefinedType Type);
...
public:
  void emitClassDefinition(mlir::clift::ClassType StructOrUnion);
...
public:
  ...
  void emitTypeTree(const mlir::clift::TypeDependencyNode &Root,
                    NodeSet &Emitted);
};
