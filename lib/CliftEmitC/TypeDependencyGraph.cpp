...
void TDG::Builder<Mode>::addNodes(mlir::clift::DefinedType Type) const {
  ...
  if (not mlir::clift::CEmitter::isDeclarationTheSameAsDefinition(Type)) {
...
void TDG::Builder<Mode>::addDependenciesFrom(const AssociatedNodes Dependent,
  ...
  using E = mlir::clift::CEmitter;
  bool ForwardDeclaration = !E::isDeclarationTheSameAsDefinition(DependentType);
  ...
  if (ForwardDeclaration
      and not E::isDeclarationTheSameAsDefinition(*DefinitionDependedOn)) {
  ...
  if (ForwardDeclaration
    ...
    if (auto Defined = mlir::dyn_cast<mlir::clift::DefinedType>(Underlying)) {
      if (not E::isDeclarationTheSameAsDefinition(Defined)) {
...
mlir::clift::TypeDependencyGraph::makeModelGraph(const mlir::ModuleOp &Module) {
  return TypeDependencyGraph::Builder<false>::make(Module);
}

mlir::clift::TypeDependencyGraph
mlir::clift::TypeDependencyGraph::makeHelperGraph(const mlir::ModuleOp
                                                    &Module) {
  return TypeDependencyGraph::Builder<true>::make(Module);
}
