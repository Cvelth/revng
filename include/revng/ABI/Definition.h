...
fields:
  ...
  - name: Types
    doc: |
      ...
      to ABI definition, e.g. how types get aligned based on their size, or,
      in the future, how vector and other non-generic types should behave.
    sequence:
      type: SortedVector
      elementType: PrimitiveTypeConstraints
    optional: true
