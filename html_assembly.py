...
def export_assembly(command: str, input_file: str, output_directory: str, working_directory):
...
def export_cfg(command: str, input_file: str, output_directory: str, working_directory):
...
def main():
    ...
    assembly_thread = Thread(
        ...
        args=(command, internal_path, arguments.output_directory, working_directory),
    )
